...
$vang ===============================================================
$cyan        ☞ YouTube: Bao Tricker 
$blue        ☞ Zalo: 0392964471
$hong        ☞ Tsr: 0329418447
$luc        ☞ Facebook: Bui Gia Bao
$do        ☞ Nhớ Đăng Kí Kênh Nha
$vang ===============================================================\n";
//login
$checkkey  = file('https://pastebin.com/raw/aL5dxbr5/key');
$lock=file_get_contents('https://pastebin.com/raw/aL5dxbr5');
...
$dem = 0;
  echo $do."[".$luc."✓".$do."] ".$trang."=> ".$luc."Nhập Token Acc Traodoisub : $vang";
  $tokenacc = trim(fgets(STDIN));
//Token 
$khoToken = [];
echo $do."[".$luc."✓".$do."] ".$trang."=> ".$luc."Nhập  Số Token Facebook Cần Làm : $vang"; 
...
//else { break; }}
echo $do."[".$luc."●".$do."] ".$trang."=> ".$luc."Sau Bao Nhiêu Thì Chống Block Hoạt Động : $yellow";
...
$maul=rand(31,37);
$maui="\033[1;".$maul."m";
    echo     " \033[1;36m[\033[1;36m$dem\033[1;36m]\033[1;33m=>\033[1;31m[\033[1;92m$time\033[1;31m]\033[1;35m=>\033[1;31m[\033[1;32m$maui$type\033[1;31m]\033[1;33m=>\033[1;31m[\033[1;91m$id\033[1;31m]\033[1;35m=>\033[1;31m[\033[1;33m$xu\033[1;31m]\033[1;35m\n";
    $len = strlen($a);
    for ($x = 0; $x < $len; $x++) {
        echo $a[$x];
        usleep(1000);
